...
def buttons():
	choice = None
	if st.button(recipe['dashboard_image.jpg'][0]['title'], key = choice):
		choice = 0
	elif st.button(recipe['dashboard_image.jpg'][1]['title'], key = choice):
		choice = 1
	elif st.button(recipe['dashboard_image.jpg'][2]['title'], key = choice):
		choice = 2
	elif st.button(recipe['dashboard_image.jpg'][3]['title'], key = choice):
		choice = 3
	elif st.button(recipe['dashboard_image.jpg'][4]['title'], key = choice):
		choice = 4
