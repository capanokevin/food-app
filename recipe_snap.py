...
class RecipeSnap(object):
    ...
    def __init__(self, checkpoint_dir='../checkpoints/model', output_size=1024, image_model='mobilenet_v2'):
        ...
        self.hydra.load_state_dict(torch.load(r'C:\Users\kevin\Desktop\Università\DataScience\Stage\model_training\best_model_4channel_prova2',map_location=torch.device('cpu')))
